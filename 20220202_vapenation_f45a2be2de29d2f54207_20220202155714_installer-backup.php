...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220202_vapenation_f45a2be2de29d2f54207_20220202155714_archive.zip';
	const ARCHIVE_SIZE		 = '102533897';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f45a2be-02155714';
    const SECONDARY_PACKAGE_HASH = '620923b-02155714';
	const VERSION			 = '1.4.4';
