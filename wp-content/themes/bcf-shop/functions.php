...
function bcf_shop_theme_setup(){
	...
	remove_action('business_consultant_finder_footer','business_consultant_finder_footer',100);
	add_action('business_consultant_finder_footer','bcf_shop_finder_footer',100);
}
...
if ( ! function_exists( 'bcf_shop_finder_footer' ) ) :
	/**
	* Footer copy right container
	*
	*/
	function bcf_shop_finder_footer (){
	?>
     ...
     <?php
      ...
      <div class="site-info">
    	<?php
                ...
                printf( esc_html__( '%1$s By aThemeArt.', 'business-consultant-finder' ), '<a href="https://athemeart.com/downloads/business-consultant-finder/" target="_blank" rel="nofollow">BCF Shop Theme</a>' );
                ?>
      </div>
      
		<?php if( get_theme_mod('social_topbar') == true ):?> 
        
        <ul class="social-inline">
          <?php  
          $array = get_theme_mod('business_consultant_finder_social_profile_link');
