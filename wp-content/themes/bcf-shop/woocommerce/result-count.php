 ...
 *
 * @package multipurpose-shop WordPress theme
 */
...
$products_per_page = get_theme_mod( 'shopstore_posts_per_page', '12' );
...
<ul class="result-count">
    <li class="view-title"><?php echo esc_html__('View:','bcf-shop'); ?>
	</li>
    ...
    <li><a class="view-second<?php if ( $num_prod == $num_prod_x2 ) echo esc_attr('active'); ?>" href="<?php echo esc_url( add_query_arg( 'products-per-page', $num_prod_x2, $link  ) ) ?>"><?php echo esc_html( $num_prod_x2 ); ?></a></li>
    <li><a class="view-all<?php if ( $num_prod == 'all' ) echo esc_attr('active'); ?>" href="<?php echo esc_url( add_query_arg( 'products-per-page', 'all', $link  ) ) ?>"><?php echo esc_html__('ALL:','bcf-shop'); ?></a></li>
</ul>
